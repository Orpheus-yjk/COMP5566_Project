...
def analyze(FILENAME, processed_evm_file, disasm_file, source_map = None):
    disasm_out = ""
    ...
    if source_map is not None:
        symExec.main(FILENAME, disasm_file, args.source, source_map)
    else:
        symExec.main(FILENAME, disasm_file, args.source)
...
def main():
    ...
    if args.bytecode:
        ...
        analyze(args.source, processed_evm_file, disasm_file)
        ...
        for cname, bin_str in contracts:
            ...
            analyze(args.source, processed_evm_file, disasm_file, SourceMap(cname, args.source))
